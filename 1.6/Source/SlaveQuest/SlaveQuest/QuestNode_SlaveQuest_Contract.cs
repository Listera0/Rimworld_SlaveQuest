...
namespace SlaveQuest
{
    ...
    public class QuestNode_SlaveQuest_Contract : QuestNode
    {
        ...
        {
            // GenerateValue
            if (Rand.Range(0, 101) > (int)(SlaveQuest_Config.QuestGenerateRate_Contract * 20)) { return false; }
        ...
        {
            // ForTest ->> QuestPart_RequirementsToAcceptSlaveQuest.CanPawnAccept -> always true
            ...
            questPart_DropRewards.inSignal = successSignal + ".LeftMap";
            questPart_DropRewards.outSignal = finishSignal;
            questPart_DropRewards.customValues = customValues;
            questPart_DropRewards.requireOptions = requireOptions;
            questPart_DropRewards.askerName = asker.LabelShort;
